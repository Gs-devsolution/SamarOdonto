                                ...
                                <div class="col-md-4 col-xl-4">
                                    <div class="card shadow-sm">
                                        <div class="card-block customer-visitor">
                                            <h2 class="text-right mt-2 f-w-300">Próxima Consulta</h2>
                                ...
                                <div class="col-md-4 col-xl-4">
                                    <div class="card shadow-sm">
                                        <div class="card-block customer-visitor">
                                            ...
                                            <span class="text-right d-block h5">Consultas Marcadas</span>
                                ...
                                <div class="col-md-4 col-xl-4">
                                    <div class="card shadow-sm">
                                        <div class="card-block customer-visitor">
                                            ...
                                            <span class="text-right d-block h5">Consultas Finalizadas</span>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <small class="text-muted">
                                                                            {{ $endedAppointment->start_date->format('d/m H:i') }}
                                                                        </small>
                                                                    </td>
                                                                </tr>
                                                            @endforeach
